...
public class myadapter extends RecyclerView.Adapter<myadapter.myviewholder>
{
    ...
    public void onBindViewHolder(@NonNull @NotNull myadapter.myviewholder holder, int position) {
          ...
          holder.reclgen.setText(users.get(position).getGender());
        holder.recllang.setText(users.get(position).getLanguage());
          ...
          holder.edbtn.setOnClickListener(new View.OnClickListener() {
              ...
              public void onClick(View view) {
                  ...
                  intent.putExtra("ugen",users.get(position).getGender());
    ...
    class myviewholder extends RecyclerView.ViewHolder
       {
           TextView recid,recfname, reclname,reclgen,recllang;
           Button delbtn,edbtn;
           public myviewholder(@NonNull @NotNull View itemView) {
               ...
               reclgen=itemView.findViewById(R.id.reclgen);
               recllang=itemView.findViewById(R.id.recllang);
